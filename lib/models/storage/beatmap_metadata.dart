...
class BeatmapMetadata {
  ...
  @ignore
  double get preempt {
    if (difficulty.ar <= 5) return 1200 + 120 * (5 - difficulty.ar);
    return 1200 - 150 * (difficulty.ar - 5);
  }
