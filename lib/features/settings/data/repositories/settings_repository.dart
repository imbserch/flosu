...
import 'package:flosu/core/repositories/with_debouncer.dart';
...
class SettingsRepository extends RepositoryWithDebouncer<Settings> {
...
final settingsRepository = Provider.autoDispose<SettingsRepository>(
