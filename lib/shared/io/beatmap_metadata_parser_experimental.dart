...
class BeatmapMetadataParser extends IoParser<BeatmapMetadata> {
  BeatmapMetadataParser(super.path);
    ...
    for (final section in sections) {
      ...
      switch (header) {
        case "[General]":
          ...
          if (mode != 0) {
            throw BeatmapIncompatibleRulesetException();
          }
        ...
        case "[Events]":
          ...
          for (final row in rawEvents) {
            ...
            if (row[0] == "0" && row[1] == "0") {
              ...
              // Set full path
              metadata.general.backgroundPath = "${file.parent.path}/$bgPath";
              break;
            }
          }
          break;
